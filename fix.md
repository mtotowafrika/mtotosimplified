    ...
    <div
      ...
      <div
        ...
        <p
          ...
          data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">
          <span class="mr-2"
            ><a href="/index.html" style="color: white">Home</a></span
          >
  ...
  <div class="container">
    <div class="row mb-5">
      <div class="col-md-6 pl-md-5 ftco-animate">
        <h2
          class="my-4 display-4 p-3 fw-bold new-title-class"
      ...
      <div class="col-md-6 bg-transparent ftco-animate">
        <div class="col-md-8 mx-auto">
          <img
            ...
            class="img-fluid text-center p-3"
            alt=""
            srcset="" />
        </div>

        <div class="col-md-8 mx-auto">
          <h4 class="text-center mtotored">Founder/ Executive Director</h4>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <h2 class="my-5 new-title-class p-3">Board of Directors</h2>
            <p class="text-center">
        ...
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <h2 class="my-5 new-title-class p-3">Volunteers</h2>
            <p class="text-center">
              Join our passionate team of volunteers and make a meaningful
              impact with Mtoto W’Afrika Child Care Ministries.
            </p>
          </div>
        </div>
        ...
        <div class="row mx-auto justify-content-center text-center">
          <div class="col-md-3 ftco-animate mb-3">
            <div class="team-member text-center">
              <img
                src="images/team/charles.png"
                class="img-fluid mb-4"
                alt="Team Member Image" />
              <h3>Charles Ondoga</h3>
              <p>Regional Co-ordinator Adjumani</p>
            </div>
          </div>
          ...
          <div class="col-md-3 ftco-animate mb-3">
            <div class="team-member text-center">
              <img
                ...
                alt="Team Member Image" />
              <h3>Alice Gulua</h3>
              <p>Community Activities Coordinator - Adjumani</p>
            </div>
          </div>
          ...
          <div class="col-md-3 ftco-animate mb-3">
            <div class="team-member text-center">
              <img
                src="images/team/alfie.png"
                class="img-fluid mb-4"
                alt="Team Member Image" />
              <h3>Alfred Ochola</h3>
              <p>IT Expert & Creative Arts Coordinator</p>
            </div>
          </div>
        </div>

        <h1 class="text-center py-5">
          <a href="/career.html" class="becomebtn btn text-white"
            >Become a Volunteer
            <span class="ms-5">
              <i class="bi bi-arrow-right-circle" title="More details"></i>
            </span>
          </a>
        </h1>
      </div>
